import { AndroidGradleAarProjectDescriptor, AndroidGradlePluginDescriptor, AndroidPublication, ModuleWindowsConfig, RawExpoModuleConfig, RawModuleConfigApple, RawWindowsModuleConfig, SupportedPlatform } from './types';
...
export declare class ExpoModuleConfig {
    ...
    /**
     * Returns the raw config for the Windows platform.
     */
    getWindowsConfig(): RawWindowsModuleConfig | null;
    /**
     * Returns a list of Windows C# module descriptors.
     */
    windowsModules(): ModuleWindowsConfig[];
    /**
     * Returns the Windows project path, if defined by the module author.
     */
    windowsProjectPath(): string | null;
    /**
     * Returns whether this module will be added only to the debug configuration on Windows.
     */
    windowsDebugOnly(): boolean;
    /**
