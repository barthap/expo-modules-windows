...
export type SupportedPlatform = 'apple' | 'ios' | 'android' | 'web' | 'macos' | 'tvos' | 'devtools' | 'windows' | (string & {});
...
export interface ModuleWindowsConfig {
    name: string | null;
    class: string;
}
export interface ModuleDescriptorWindows extends CommonNativeModuleDescriptor {
    modules: ModuleWindowsConfig[];
    projectPath: string | null;
    debugOnly: boolean;
}
export type ModuleDescriptor = ModuleDescriptorAndroid | ModuleDescriptorIos | ModuleDescriptorDevTools | ModuleDescriptorWeb | ModuleDescriptorWindows;
...
export type RawWindowsModuleEntry = {
    name: string;
    class: string;
};
export type RawWindowsModuleConfig = {
    modules?: (string | RawWindowsModuleEntry)[];
    projectPath?: string;
    debugOnly?: boolean;
};
...
export interface RawExpoModuleConfig {
     ...
     */
    windows?: RawWindowsModuleConfig;
    /**
